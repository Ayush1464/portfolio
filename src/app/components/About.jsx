    ...
    <section id="about" className="py-32 px-6 relative">
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="aspect-square bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-xl border border-blue-500/20 rounded-2xl flex items-center justify-center p-12">
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto mb-6 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 p-1">
                    <div className="w-full h-full rounded-full bg-slate-100 dark:bg-[#0a0a0f] flex items-center justify-center text-6xl shadow-inner">
                      👨‍💻
                    </div>
                  </div>
          ...
          >
            <p className="text-gray-600 dark:text-gray-300 text-lg mb-6 leading-relaxed font-normal">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg mb-8 leading-relaxed font-normal">
            ...
            <div className="grid grid-cols-2 gap-4">
              {highlights.map((item, index) => (
                <motion.div
                  ...
                  className="group p-4 rounded-xl bg-blue-500/5 dark:bg-gradient-to-br dark:from-blue-500/5 dark:to-purple-500/5 border border-blue-500/20 dark:border-blue-500/10 hover:border-blue-500/40 backdrop-blur-sm transition-all duration-300 hover:shadow-[0_0_20px_rgba(99,102,241,0.2)]"
                >
                  <item.icon className="w-6 h-6 text-blue-500 dark:text-blue-400 mb-2 group-hover:scale-110 transition-transform" />
